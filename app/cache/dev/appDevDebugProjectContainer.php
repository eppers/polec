...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', '/home/petre/domains/petre.pl/public_html/polec/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/home/petre/domains/petre.pl/public_html/polec/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => 3306, 'dbname' => 'petre_polec', 'user' => 'petre_polec', 'password' => 'pVcHE7lJ', 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_15c8ed62a468419f4bb82c8b916a2ca34ebe33efb6f86e5442a2503ba2f608ff');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_15c8ed62a468419f4bb82c8b916a2ca34ebe33efb6f86e5442a2503ba2f608ff');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_15c8ed62a468419f4bb82c8b916a2ca34ebe33efb6f86e5442a2503ba2f608ff');

        $d = new \Doctrine\ORM\Mapping\Driver\SimplifiedYamlDriver(array('/home/petre/domains/petre.pl/public_html/polec/src/Acme/RecommendBundle/Resources/config/doctrine' => 'Acme\\RecommendBundle\\Entity'));
        $d->setGlobalBasename('mapping');

        $e = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $e->addDriver($d, 'Acme\\RecommendBundle\\Entity');
        $e->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/home/petre/domains/petre.pl/public_html/polec/vendor/sonata-project/core-bundle/Sonata/CoreBundle/Entity')), 'Sonata\\CoreBundle\\Entity');

        $f = new \Doctrine\ORM\Configuration();
        $f->setEntityNamespaces(array('AcmeRecommendBundle' => 'Acme\\RecommendBundle\\Entity', 'SonataCoreBundle' => 'Sonata\\CoreBundle\\Entity'));
        $f->setMetadataCacheImpl($a);
        $f->setQueryCacheImpl($b);
        $f->setResultCacheImpl($c);
        $f->setMetadataDriverImpl($e);
        $f->setProxyDir('/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/home/petre/domains/petre.pl/public_html/polec/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/home/petre/domains/petre.pl/public_html/polec/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/home/petre/domains/petre.pl/public_html/polec/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/home/petre/domains/petre.pl/public_html/polec/app');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    protected function getSonata_Admin_PoolService()
    {
        ...
        $instance->setAdminServiceIds(array(0 => 'sonata.admin.post'));
        $instance->setAdminGroups(array('Content' => array('label' => 'Content', 'label_catalogue' => 'SonataAdminBundle', 'roles' => array(), 'items' => array(0 => 'sonata.admin.post'))));
        $instance->setAdminClasses(array('Acme\\RecommendBundle\\Entity\\Users' => 'sonata.admin.post'));
     ...
     *
     * @return Acme\RecommendBundle\Admin\UserAdmin A Acme\RecommendBundle\Admin\UserAdmin instance.
     */
    protected function getSonata_Admin_PostService()
    {
        $instance = new \Acme\RecommendBundle\Admin\UserAdmin('sonata.admin.post', 'Acme\\RecommendBundle\\Entity\\Users', 'SonataAdminBundle:CRUD');

        $instance->setTranslationDomain('AcmeRecommendBundle');
    ...
    {
        return $this->services['sonata.admin.route_loader'] = new \Sonata\AdminBundle\Route\AdminPoolLoader($this->get('sonata.admin.pool'), array(0 => 'sonata.admin.post'), $this);
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/home/petre/domains/petre.pl/public_html/polec/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/home/petre/domains/petre.pl/public_html/polec/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/home/petre/domains/petre.pl/public_html/polec/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/home/petre/domains/petre.pl/public_html/polec/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/home/petre/domains/petre.pl/public_html/polec/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/home/petre/domains/petre.pl/public_html/polec/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/home/petre/domains/petre.pl/public_html/polec/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/home/petre/domains/petre.pl/public_html/polec/src/Acme/RecommendBundle/Resources/views', 'AcmeRecommend');
        $instance->addPath('/home/petre/domains/petre.pl/public_html/polec/vendor/sonata-project/core-bundle/Sonata/CoreBundle/Resources/views', 'SonataCore');
        $instance->addPath('/home/petre/domains/petre.pl/public_html/polec/vendor/sonata-project/block-bundle/Sonata/BlockBundle/Resources/views', 'SonataBlock');
        $instance->addPath('/home/petre/domains/petre.pl/public_html/polec/vendor/sonata-project/doctrine-orm-admin-bundle/Sonata/DoctrineORMAdminBundle/Resources/views', 'SonataDoctrineORMAdmin');
        $instance->addPath('/home/petre/domains/petre.pl/public_html/polec/vendor/sonata-project/admin-bundle/Sonata/AdminBundle/Resources/views', 'SonataAdmin');
        $instance->addPath('/home/petre/domains/petre.pl/public_html/polec/src/Acme/UserBundle/Resources/views', 'AcmeUser');
        $instance->addPath('/home/petre/domains/petre.pl/public_html/polec/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/home/petre/domains/petre.pl/public_html/polec/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/home/petre/domains/petre.pl/public_html/polec/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/home/petre/domains/petre.pl/public_html/polec/app/Resources/views');
        $instance->addPath('/home/petre/domains/petre.pl/public_html/polec/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
        $instance->addPath('/home/petre/domains/petre.pl/public_html/polec/vendor/knplabs/knp-menu/src/Knp/Menu/Resources/views');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/petre/domains/petre.pl/public_html/polec/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/petre/domains/petre.pl/public_html/polec/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => '/home/petre/domains/petre.pl/public_html/polec/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/home/petre/domains/petre.pl/public_html/polec/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/petre/domains/petre.pl/public_html/polec/app/cache/dev',
            'kernel.logs_dir' => '/home/petre/domains/petre.pl/public_html/polec/app/logs',
            'kernel.bundles' => array(
                ...
                'AcmeRecommendBundle' => 'Acme\\RecommendBundle\\AcmeRecommendBundle',
            ...
            'database_port' => 3306,
            'database_name' => 'petre_polec',
            'database_user' => 'petre_polec',
            'database_password' => 'pVcHE7lJ',
            ...
            'debug.container.dump' => '/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => '/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => '/home/petre/domains/petre.pl/public_html/polec/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/profiler',
            ...
            'router.resource' => '/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/home/petre/domains/petre.pl/public_html/polec/app/../web',
            'assetic.write_to' => '/home/petre/domains/petre.pl/public_html/polec/app/../web',
            'assetic.variables' => array(

            ),
            'assetic.java.bin' => '/usr/bin/java',
            'assetic.node.bin' => '/usr/bin/node',
            'assetic.ruby.bin' => '/usr/local/rvm/rubies/ruby-1.9.3-p484/bin/ruby',
            ...
            'doctrine.orm.proxy_dir' => '/home/petre/domains/petre.pl/public_html/polec/app/cache/dev/doctrine/orm/Proxies',
